 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://services.soap/", wsdlLocation = "http://localhost:8080/CalculatorJAX_BU/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://services.soap/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorJAX_BU/calculator?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://services.soap/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.soap/", "CalculatorImplPort"), Calculator.class, features);
    }
